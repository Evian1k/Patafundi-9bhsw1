...
const STATIC_SECTIONS: InfoSection[] = [
  {
    ...
    bullets: [
      ...
      'Suspected fraud or scam in progress',
    ],
  },
  {
    icon: 'bulb',
  ...
  },
  {
    icon: 'checkmark-done',
    title: 'After SOS',
    body: 'Once SOS is triggered, we follow up with you within 24 hours. You can file a formal report, and the fundi may be suspended pending investigation. Your safety, not the fundi\'s reputation, comes first.',
    color: colors.accent,
  },
];

export function EmergencySosScreen({ navigation }: any): JSX.Element {
