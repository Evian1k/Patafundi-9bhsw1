...
import { colors, fonts, fontSize, spacing, borderRadius, gradients, shadows } from '../theme';
...
/** Policy cards that are identical in every PataFundi app. */
export const LEGAL_TRUST_CARDS: TrustCard[] = [
...
export interface TrustCenterScreenProps {
  navigation: any;
  cards: TrustCard[];
  heroSubtitle: string;
}

export function TrustCenterScreen({ navigation, cards, heroSubtitle }: TrustCenterScreenProps): JSX.Element {
  ...
  return (
    ...
    >
      <ScreenHeader title="Trust & Safety" onBack={() => navigation.goBack()} />
